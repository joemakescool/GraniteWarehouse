...
namespace GraniteWarehouse.Areas.Admin.Controllers
{
    ...
    public class AdminUsersController : Controller
    {
        ...
        private readonly ApplicationDbContext _db; // dependancy injection here :)!
        ...
        {
            if (id == null || id.Trim().Length == 0)//removes all trailing whitespace
            {
                return NotFound(); //a html page
            }
        ...
        public IActionResult Edit(string id, ApplicationUser applicationUser)
        {
            ...
            {
                ApplicationUser userFromDb = _db.ApplicationUser.Where(u => u.Id == applicationUser.Id).FirstOrDefault();
